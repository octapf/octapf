...
export const MainContent = () => {
    ...
    const experienceDataOne = {
        ...
        dateRange: (
            <>
                {t('February 2023 - present')} ({actualJobDuration}{' '}
                {t('months')})
                <br />
            </>
        ),
            ...
            <Section id="skills">
                ...
                <div className="flex-row-skills">
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-html5 html-icon" />
                            <strong> HTML5</strong>
                        </p>
                    </article>
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-css3-alt css-icon" />
                            <strong> CSS3</strong>
                        </p>
                    </article>
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-js js-icon" />
                            <strong> JavaScript</strong>
                        </p>
                    </article>
                    <article className="skill-article">
                        <p>
                            <em className="fab fa-bootstrap bs-icon" />
                            <strong> Bootstrap</strong>
                        </p>
                    </article>
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-react react-icon" />
                            <strong> React</strong>
                        </p>
                    </article>
                    <article className="skill-article">
                    ...
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-node node-icon" />
                    ...
                    <article className="skill-article">
                        <p>
                            <em className="fa-brands fa-git-alt git-icon" />
                            <strong> Git</strong>
                        </p>
                    </article>
                </div>
